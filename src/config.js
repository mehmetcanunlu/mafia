...
export const DIPLOMASI = {
  ...
  TICARET_SURESI: 8,
  TICARET_GELIR_BONUS: 0.06,
  TICARET_MIN_SERMAYE: 220,
  TICARET_BATMA_SANSI: 0.04,
  TICARET_BATMA_PARA_ORANI: 0.12,
  TICARET_BATMA_MIN_KAYIP: 35,
  TICARET_BATMA_MAX_KAYIP: 180,
  TICARET_BATMA_ILISKI_CEZASI: -8,
  ...
  SAVAS_SKOR_FETIH: 16,
  SAVAS_SKOR_SAVUNMA: 8,
  SAVAS_SKOR_KAYIP_ETKISI: 0.28,
  SAVAS_SKOR_UST_LIMIT: 100,
  SAVAS_YORGUNLUK_TUR: 0.9,
  SAVAS_YORGUNLUK_KAYIP_ETKISI: 0.16,
  SAVAS_BARISE_ZORLAMA_SKORU: -38,
  SAVAS_BARISE_ZORLAMA_YORGUNLUK: 62,
};
